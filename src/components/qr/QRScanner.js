...
const QRScanner = ({ sub, onComplete }) => {
  ...
  const renderContent = () => {
    switch (status) {
      case 'initial':
        return (
          <div className="w-full max-w-md mx-auto bg-white rounded-xl p-6 shadow-lg">
            <div className="flex items-center justify-between mb-4">
              <button className="text-gray-600 hover:text-[#243ce6] transition-colors">
                <ArrowLeft size={20} />
              </button>
              <span className="text-[#243ce6] font-semibold text-lg">KeySync</span>
              <button className="text-gray-600 hover:text-[#243ce6] transition-colors">
                <X size={20} />
              </button>
            </div>
            ...
            <div className="flex justify-center items-center space-x-8 my-8">
              <div className="bg-gray-50 p-4 rounded-xl shadow-md">
                <img src={`${process.env.PUBLIC_URL}/KS-removebg-preview.png`} alt="App Logo" className="w-14 h-14" />
              </div>
              <div className="flex items-center text-[#243ce6]">
                <div className="w-16 border-t-2 border-dashed border-[#243ce6]"></div>
              </div>
              <div className="bg-gray-50 p-4 rounded-xl shadow-md">
                <img src={`${process.env.PUBLIC_URL}/WhatsApp_logo.png`} alt="WhatsApp Logo" className="w-14 h-14" />
              </div>
            </div>

            <p className="text-gray-700 text-center text-sm mb-6 leading-relaxed">
              Vincula KeySync con WhatsApp para crear tu CRM de manera automática. 
              Al continuar, aceptas los <a href="#" className="text-[#243ce6] hover:text-[#1a2db8] font-medium transition-colors">términos y condiciones</a>
            </p>

            <button 
              onClick={startWhatsAppSync}
              className="w-full bg-[#243ce6] text-white py-3.5 rounded-xl hover:bg-[#1a2db8] font-medium transition-colors shadow-md hover:shadow-lg"
              disabled={loading}
            >
              {loading ? (
            ...
            <p className="text-gray-600 text-sm text-center mt-4">
              ¿Necesitas ayuda? Por favor contacta con{' '}
              <a href="#" className="text-[#243ce6] hover:text-[#1a2db8] font-medium transition-colors">
                soporte
              </a>
            </p>
          </div>
        ...
        return (
          <div className="w-full max-w-md mx-auto bg-white p-8 rounded-xl shadow-lg">
            <div className="text-center mb-8">
              <h2 className="text-2xl font-bold mb-3 text-gray-800">Vincular WhatsApp</h2>
            ...
            <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
              <div className="space-y-4 text-sm text-gray-700">
                <ol className="list-decimal list-inside space-y-4">
                  <li className="leading-relaxed">Abre WhatsApp en tu teléfono.</li>
                  <li className="flex items-center flex-wrap leading-relaxed">
                    Toca <strong className="mx-1 text-gray-900">Menú</strong> 
                    <span className="mx-1 inline-flex items-center">
                      <svg height="18px" viewBox="0 0 24 24" width="18px" className="align-middle">
                    ...
                    en Android o <strong className="mx-1 text-gray-900">Ajustes</strong>
                    <span className="mx-1 inline-flex items-center">
                      <svg width="18" height="18" viewBox="0 0 24 24" className="align-middle">
                  ...
                  <li className="leading-relaxed">
                    Toca <strong className="text-gray-900">Dispositivos vinculados</strong> y, luego,{' '}
                    <strong className="text-gray-900">Vincular un dispositivo</strong>.
                  </li>
                  <li className="leading-relaxed">
      ...
      case 'complete':
        return (
          <div className="w-full max-w-md mx-auto bg-white p-8 rounded-xl shadow-lg text-center">
            <Loader2 className="h-14 w-14 animate-spin mx-auto mb-6 text-[#243ce6]" />
            <h3 className="text-xl font-bold mb-3 text-gray-800">Sincronizando contactos</h3>
            <p className="text-gray-600 leading-relaxed">
